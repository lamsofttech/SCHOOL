...
<?php
 ...
 $sid =$fname= $exm= $ = $gender = $address = $parent=" ";
...
$remark=$_POST['remark'];
$grade=$_POST['grade'];
$ngrade=$_POST['newgrade'];
$query=mysqli_query($con,"update complaintremark set status='$status',remark='$remark' where complaintNumber='$complaintnumber'");

$sql=mysqli_query($con,"update tblmissingunits set status='$status',grade='$grade',newgrade='$grade' where complaintNumber='$complaintnumber'");
